...
const tabs = [
  { id: 'santri', label: 'Santri Queries', icon: '👥' },
  { id: 'pesantren', label: 'Pesantren Queries', icon: '🏫' },
  { id: 'general', label: 'General Queries', icon: '🔍' },
]
    ...
    <div class="page-header">
      <div class="header-content">
        ...
        <p class="page-description">
          Tanyakan tentang data santri dan pesantren menggunakan bahasa natural
        </p>
      </div>
    </div>
      ...
      <div class="content-grid">
        ...
        <div class="widget-section">
          <NL2SQLWidget
            ...
            :placeholder="`Tanyakan tentang ${activeTab === 'santri' ? 'santri' : activeTab === 'pesantren' ? 'pesantren' : 'data'}...`"
            @result="handleResult"
            @error="handleError"
          />
        </div>
